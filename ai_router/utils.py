"""
utils.py — Small in-process helpers for ai_router.
...
# 1. Escalation
# ----------------------------------------------------------------------
# Formerly ai_router/escalation.py.
# ======================================================================
...
# 2. Rate limiting
# ----------------------------------------------------------------------
# Formerly ai_router/rate_limiter.py.
# ======================================================================
...
# ----------------------------------------------------------------------
# Formerly ai_router/utils/load_env.py.
#
...
# ----------------------------------------------------------------------
# Formerly ai_router/utils/kill_conhost.py.
#
