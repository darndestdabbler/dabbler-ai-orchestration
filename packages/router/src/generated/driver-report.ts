...
export type DriverReport = {
  ...
  /**
   * True when the report named no files: the driver takes the step's files from the diff since the last accepted step, less what the framework wrote itself, and `files_changed` is empty.
   */
