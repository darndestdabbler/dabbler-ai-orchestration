 ...
 *
 * Both states the seat has an answer for: a probe took a turn and it
 * answered, or the seat itself states it will dispatch the model. What is
 * excluded is the entry nothing has said anything about, and a provider the
 * process could not route to.
 */
