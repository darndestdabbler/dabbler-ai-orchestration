...
- **Codex.** Not installed on this machine. It is covered by
  ...
  editor it is not, until its variables are measured; the guide says how a
  person marks that terminal, and
  `docs/design/engine-environment-markers.md` states the limit.
