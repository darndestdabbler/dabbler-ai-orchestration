...
| 127 | Focused or global — the plan says which, one click starts it, the framework pulls | — | not declared |
...
| 130 | The UAT that tests the UI, and shows its own machinery | — | not declared |
