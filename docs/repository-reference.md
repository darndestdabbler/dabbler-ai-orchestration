...
|---|---|---|---|
| `dabbler-ai-router` | `0.17.0` | **Published to PyPI 2026-06-12** (tag `v0.17.0`, release.yml run 27417089861) — ships the Set 062 blessed verification-mode writer + migrator-CLI cp1252 fix. | `pyproject.toml`, `ai_router/CHANGELOG.md` |
| `dabbler-ai-orchestration` VS Code extension | `0.30.0` | **Published 2026-06-12** to the VS Code Marketplace + Open VSX (tag `vsix-v0.30.0`, publish-vscode.yml run 27417089796) — combined release carrying Sets 061 + 062, after the local operator UAT gate passed (combined 23-row checklist) and the operator authorized the tag pushes in-session. | `tools/dabbler-ai-orchestration/package.json`, `tools/dabbler-ai-orchestration/CHANGELOG.md` |
