...
function buildMovedMachine(target: string, context: BuildContext): string {
  ...
  // A shallow-free clone of the branch only: `refs/dabbler/rounds/*` is not
  // in the default refspec, which is exactly why the tree goes missing.
  git(target, "clone", "-q", origin, clone);
