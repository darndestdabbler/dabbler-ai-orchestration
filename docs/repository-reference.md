...
|---|---|---|---|
| `dabbler-ai-router` | `0.17.0` | **Version-bumped 2026-06-12, publish PENDING** — ships the Set 062 blessed verification-mode writer + migrator-CLI cp1252 fix. Tag `v0.17.0` not yet pushed; awaiting operator authorization. Last published: `0.16.0` (2026-06-05, tag `v0.16.0`, release.yml run 27023463909). | `pyproject.toml`, `ai_router/CHANGELOG.md` |
| `dabbler-ai-orchestration` VS Code extension | `0.30.0` | **Version-bumped 2026-06-12, publish PENDING** — combined release carrying Sets 061 + 062; local operator UAT passed 2026-06-12 (combined 23-row checklist). Tag `vsix-v0.30.0` not yet pushed; awaiting operator authorization. Last published: `0.29.0` (2026-06-11, tag `vsix-v0.29.0`, publish-vscode.yml run 27340063729). | `tools/dabbler-ai-orchestration/package.json`, `tools/dabbler-ai-orchestration/CHANGELOG.md` |

### Recent version walk

- **Extension `0.30.0` + `dabbler-ai-router 0.17.0`** — Sets 061 + 062 combined (Explorer UX polish: `N/M+`, `lw` marker, blocked chain marker, `Switch Tier…`; Lightweight verification affordance: `v?`/`v+` markers, Verification Kickoff prompt, `Set Up Dedicated Verification…`, the `change_verification_mode` blessed writer, the UAT fixture workspace; migrator-CLI cp1252 fix). Local operator UAT passed 2026-06-12; **both publishes pending operator-authorized tag pushes** (`vsix-v0.30.0`, `v0.17.0`).
