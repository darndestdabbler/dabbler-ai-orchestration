...
| [tools/dabbler-ai-orchestration/dabbler-ai-orchestration-0.29.0.vsix](../tools/dabbler-ai-orchestration/dabbler-ai-orchestration-0.29.0.vsix) | Most recent committed VSIX (the Set 060 release build). The Marketplace install (`code --install-extension DarndestDabbler.dabbler-ai-orchestration`) is the recommended path; this committed VSIX is the offline / firewall-blocked fallback. |
