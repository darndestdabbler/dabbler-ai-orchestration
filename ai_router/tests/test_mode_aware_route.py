"""Unit tests for mode-aware route() and verify() in ai_router/__init__.py.
...
AI_ROUTER_INIT = REPO_ROOT / "ai_router" / "__init__.py"
AI_ROUTER_DIR = REPO_ROOT / "ai_router"


@pytest.fixture(scope="module")
def ai_router():
    """Load ai_router as a real package and return the module."""
