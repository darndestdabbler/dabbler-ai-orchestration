...
# conftest puts ai-router/ on sys.path
...
def _repo_root() -> Path:
    # tests/ lives at <repo>/ai-router/tests; two parents up is the repo root.
...
class TestReferenceFile:
    def test_committed_reference_matches_generator(self):
        ...
        # generator. Run:
        #   python ai-router/dump_session_state_schema.py --write \
        #     docs/session-state-schema-example.json
...
class TestCli:
    ...
    def test_subprocess_invocation_of_check_against_real_reference(self):
        ...
        script = _repo_root() / "ai-router" / "dump_session_state_schema.py"
