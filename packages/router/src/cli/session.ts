...
const OPTIONS: Record<string, readonly string[]> = {
  start: [
    ...
    "  --reviewer-transport T   the vehicle THIS session's reviewers are reached through,",
    "                           kept as the two below are. It decides which list they",
    "                           are drawn from",
...
`,
  ...
  if (subcommand === "start") {
    ...
    return await start(sessionsDir, {
      ...
      reviewerTransport: values.get("--reviewer-transport") ?? null,
