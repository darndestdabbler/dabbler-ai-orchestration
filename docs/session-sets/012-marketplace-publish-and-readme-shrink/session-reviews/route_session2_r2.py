"""Round 2 verification routing script for Set 012 Session 2.

Same defensive shape as route_session2.py: dump RouteResult to JSON
BEFORE any attribute access, so a follow-up attribute-name mismatch
cannot lose the verifier's response.
"""
import json
import sys
import dataclasses
...
PROMPT = (REVIEW_DIR / "session-002-prompt-r2.md").read_text(encoding="utf-8")
RAW_DUMP = REVIEW_DIR / "session-002-r2-raw.json"
OUTPUT_MD = REVIEW_DIR / "session-002-r2.md"
