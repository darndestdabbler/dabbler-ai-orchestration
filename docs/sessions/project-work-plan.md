...
| 132 | The rest of the first-run path | — | not declared |
| 133 | The four papercuts, and the walk's own record closed | — | not declared |
| 134 | What the verifier is told, and what it can see | — | not declared |
| 135 | The direct-API verifier can ask for a file | — | not declared |
| 136 | Codex leaves the documented surface, and the block lands | — | not declared |
