...
const USAGE = [
  ...
  "         [--session-set-dir <path>]   where the RECORDED session's own",
  "                                      activity-log.json and",
  "                                      session-events.jsonl live; the speed",
  "                                      ramp reads them to find the waiting.",
  "                                      Defaults to docs/session-sets/<slug>",
  "                                      in THIS repo -- pass it whenever the",
  "                                      recorded session belongs to another",
  "                                      project (a tutorial recording does).",
