"""Verification routing script for Set 012 Session 3.
...
PROMPT = (REVIEW_DIR / "session-003-prompt.md").read_text(encoding="utf-8")
RAW_DUMP = REVIEW_DIR / "session-003-raw.json"
OUTPUT_MD = REVIEW_DIR / "session-003.md"
