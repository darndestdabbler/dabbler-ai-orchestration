...
# header for the rationale (three import shapes supporting package,
# test-conftest, and __main__ invocation paths). Keeping them in
# lockstep means a future restructuring touches both files identically.
