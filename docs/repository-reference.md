...
| `dabbler-ai-orchestration` VS Code extension | `0.31.0` | **Published 2026-06-12** to the VS Code Marketplace + Open VSX (tag `vsix-v0.31.0`, publish-vscode.yml run 27424322879) — Cost Dashboard session-set normalization + README two-tier cost/attention framing. First release through the green-Test gate (the `require-green-test` job waited on the bump commit's Test run 27424321726, then passed). | `tools/dabbler-ai-orchestration/package.json`, `tools/dabbler-ai-orchestration/CHANGELOG.md` |
