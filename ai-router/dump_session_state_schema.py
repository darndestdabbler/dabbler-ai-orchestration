...
::
    ...
    python ai-router/dump_session_state_schema.py --write path/to/example.json
...
if __name__ == "__main__" and __package__ in (None, ""):
    ...
    # ``python ai-router/dump_session_state_schema.py``. The parent
    # directory ``ai-router/`` holds the sibling modules; adding it to
    ...
    *,
    ...
    if not reference_path.is_file():
        print(
            ...
            f"Regenerate with: python ai-router/dump_session_state_schema.py "
    ...
    if actual != expected:
        print(
            ...
            f"ai-router/dump_session_state_schema.py --write {REFERENCE_PATH}",
            file=stderr,
        )
        return 1
