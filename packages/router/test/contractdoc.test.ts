...
describe("the module form", () => {
  ...
  it("reads a designed surface from the abstractions project's source, with its summaries, and marks it designed", () => {
    ...
    // The notes page is rendered from the contract.yaml beside it -- the
    // file form's renderer, with the module's place in the graph -- and is
    // written back as README.md; without a yaml, the page is the author's.
    ...
    assert.doesNotMatch(bundle.notes, /Saving twice keeps one/);
