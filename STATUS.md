...
> claim in `vitest.config.ts` is replaced by that table. **The operator's
> own feel of the machine was not sampled** -- the probe stood in -- and is
> theirs to confirm. Raw numbers were in `.dabbler/scratch/measure/`,
> untracked.
>
