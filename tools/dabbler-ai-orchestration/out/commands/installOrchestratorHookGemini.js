...
function registerInstallOrchestratorHookGeminiCommand(context) {
    context.subscriptions.push(vscode.commands.registerCommand("dabbler.installOrchestratorHook.gemini", () => vscode.commands.executeCommand("dabbler.checkOutOrchestrator", {
