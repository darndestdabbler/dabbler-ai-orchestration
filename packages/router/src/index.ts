...
// Whether the session a start would register is a release session: Start
// Session then opens no engine CLI, and asks nothing.
export { releaseSessionToStart } from "./session.ts";
