...
for (const file of files) {
  ...
  // Static imports and re-exports (`from "..."`) AND dynamic imports
  // (`import("...")`): the verify layer reaches `route` dynamically, and a
  // scanner blind to that edge fails open on exactly the kind of coupling
  // it exists to hold.
  const specifiers = [
