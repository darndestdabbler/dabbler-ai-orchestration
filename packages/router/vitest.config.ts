...
// session-66 incident alone. The operator's own feel of the machine was not
// sampled in that session -- the probe stood in for it -- and is theirs to
// confirm; session 77 attacks the critical path itself.
