 ...
 * that back.
 *
 * Two assertions, and neither says a declared edge WAS reached -- so both
 * hold under a filtered run:
 *
 ...
 *   driving an edge nobody recorded, and is what keeps that field honest.
 */
