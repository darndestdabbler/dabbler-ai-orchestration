...
describe("a stop, as a person reads it", () => {
  ...
  it("tells the four verification stops apart: four accounts, four sets of moves", () => {
    ...
    const codes = ["no-verdict", "dispute-refused", "cap-unresolved", "cap-disputed", "cap-terminal-tree-moved"];
  ...
  it("names its refusal from a closed vocabulary, or names none at all", () => {
    ...
    for (const code of ["no-verdict", "dispute-refused", "cap-unresolved", "cap-disputed", "cap-terminal-tree-moved", null]) {
