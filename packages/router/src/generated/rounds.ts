...
export type Rounds = {
  ...
  /**
   * Prompt tokens the round spent, as the provider counted them. Null on a transport that reports none.
   */
  ...
  /**
   * Agentic turns inside this ONE round. It is the multiplier nothing surfaced: 3 rounds became 26 billed calls because each round's agency turns are each priced, and a round count alone cannot show that.
   */
