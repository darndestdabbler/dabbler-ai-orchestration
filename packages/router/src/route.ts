...
/**
 * The transport could not complete the call (classified error on the Copilot
 * path; exhausted retries on the API path). Carries the failing provider so
 * a caller can retry excluding it.
 */
