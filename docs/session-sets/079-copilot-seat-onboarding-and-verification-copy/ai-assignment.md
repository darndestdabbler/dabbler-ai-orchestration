...
- Total routed cost: $0.25 in router-metrics (documentation gemini-pro $0.03 + gpt-5-4-mini auto-verify $0.04; session-verification gpt-5-4 2 rounds $0.15 + $0.05); the three pull-critique producer runs (2 arms each: gemini-2.5-pro + gpt-5.4 over the full repo) meter outside router-metrics.jsonl and are additional.
