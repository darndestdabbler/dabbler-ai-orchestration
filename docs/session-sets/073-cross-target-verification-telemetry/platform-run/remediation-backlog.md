# Remediation backlog - dabbler-platform

- generated at: 2026-06-19T16:02:29.565115-04:00
- runs aggregated: 1
- provenance complete: False
- NOTE: provenance is incomplete (pushUnkeyed=1, pullUnkeyed=2); an unkeyed defect cannot corroborate across runs, so it appears once per run that caught it.
- findings: 3

## 1. [Major] Completeness - push-only (corroboration=1)
- defect key: (unkeyed)
- surfaces: push
- surfaced by runs: #0@82a95ab..d66c449
...
## 2. [Major] contract-drift - pull-only (corroboration=1)
- defect key: (unkeyed)
- surfaces: pull
- surfaced by runs: #0@82a95ab..d66c449
- (pull) Severity: Major
...
## 3. [Major] contract-drift - pull-only (corroboration=1)
- defect key: (unkeyed)
- surfaces: pull
- surfaced by runs: #0@82a95ab..d66c449
- (pull) Severity: Major
