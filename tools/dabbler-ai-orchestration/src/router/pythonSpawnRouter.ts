...
import { RouterCliResult, RunRouterCliDeps, runRouterCli } from "../utils/routerCli";
import { parseProjectionPayload } from "./projectionPayload";

/**
 * The half of an answer a caller reports: a refusal, a failed write, or a
 * failure. Named because every command flow reports one, and none of them
 * should have to spell the discriminated union out.
 */
...
export class PythonSpawnRouter implements Router {
  /**
