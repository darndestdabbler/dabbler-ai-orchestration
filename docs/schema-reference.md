...
`session drive` re-runs from the phase it reached; a stop that arrives while
no invocation is running is honoured at the next phase boundary, where a
plain request would have been discarded. A person
