...
exports.registerInstallOrchestratorHookGeminiCommand = registerInstallOrchestratorHookGeminiCommand;
...
function registerInstallOrchestratorHookGeminiCommand(context) {
    context.subscriptions.push(vscode.commands.registerCommand("dabbler.installOrchestratorHook.gemini", async () => {
        await (0, newChatIdWorkflowToast_1.maybeShowNewChatIdWorkflowToast)(context, "Gemini Code Assist", newChatIdWorkflowToast_1.NEW_CHAT_ID_TOAST_SUPPRESS_KEY_GEMINI);
        await vscode.commands.executeCommand("dabbler.checkOutOrchestrator", { prefillProvider: "google" });
    }));
}
//# sourceMappingURL=installOrchestratorHookGemini.js.map