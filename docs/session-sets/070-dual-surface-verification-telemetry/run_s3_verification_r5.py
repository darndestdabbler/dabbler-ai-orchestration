"""Set 070 S3 -- cross-provider session verification ROUND 5 (authoritative final
...
CONVENTIONS = """\
=== UP-FRONT CONVENTIONS (Round 5, authoritative final gate) ===

ROUND 5. SUITE: 2079 passed / 5 skipped, GREEN (5 skips = Set 069 S4
...
HOW R4'S TWO ISSUES WERE RESOLVED (review these):
...
out = HERE / "s3-verification-round-5.md"
